...
v0.new("<Color=Cyan>Welcome to volamanh hub<Color=/>"):Display();
wait(0.5);
...
v5.Window = function(v134, v135)
	...
	v170.Image = "http://www.roblox.com/asset/?id="   .. tostring(volamanh hub) ;
...
v8.Image = "rbxassetid://volamanh hub";
v8.Draggable = true;
...
game:GetService("StarterGui"):SetCore("SendNotification", {
	Title = "volamanh hub",
	Text = "Loading...",
	Icon = "rbxthumb://type=Asset&id=137040007080639&w=150&h=150",
	Duration = 10
});
spawn(function()
	while wait() do
